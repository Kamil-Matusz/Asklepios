    ...
    public async Task SeedAsync(AsklepiosDbContext dbContext)
    {
        ...
        if (!nurses.Any())
        {
            var newNurses = new List<Nurse>()
            {
                ...
                new Nurse(Guid.Parse("602a9ff4-544b-4df0-a15b-660c55384994"), "Marta", "Piotrowska", Guid.Parse("a4c69f2b-dcf3-4e8b-baa6-1275122c4e68"), Guid.Parse("2a9f1b22-1854-43f2-a30b-c34d3d70f2c9"))
            };
