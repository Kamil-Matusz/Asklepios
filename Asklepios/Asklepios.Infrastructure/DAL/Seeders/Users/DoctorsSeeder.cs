    ...
    public async Task SeedAsync(AsklepiosDbContext dbContext)
    {
        ...
        if (!doctors.Any())
        {
            var newDoctors = new List<MedicalStaff>()
            {
                ...
                new MedicalStaff(Guid.Parse("e582299d-1a49-4d7b-8e36-eadb449dd212"), "Milosz", "Michalski", "+48602123456", "+48567432145", "Ortopeda", "ABC236", Guid.Parse("91fc545f-4732-419f-812a-9e9603b515c6"), Guid.Parse("98113a7d-371a-4561-84e0-bf664e9e8031")),
