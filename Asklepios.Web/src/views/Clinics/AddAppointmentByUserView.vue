<template>
  <BasePage title="Zapisz się do lekarza">
    <v-container>
      <v-row justify="center">
        <v-col cols="12" md="8">
          <v-card>
            <v-card-title>Zarejestruj się na nową wizytę</v-card-title>
            <v-card-text>
...
async function createAppointment() {
  try {
    await clinicAppointmentsStore.dispatchCreateAppointmentByUser(appointmentRequest);
